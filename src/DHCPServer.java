...
public class DHCPServer {
    ...
    private static final int IP_POOL_START = 10;   // Начало диапазона (192.168.1.10)
    private static final int IP_POOL_END = 100;    // Конец диапазона (192.168.1.100)
    ...
    public static void main(String[] args) {
        ...
        // Запрашиваем порт для DHCP-сервера
        ...
        // Создаем  сокет, используя конструкцию try-with-resources для автоматического закрытия ресурсов
    ...
    private static void processDhcpDiscover(String clientMAC, Socket clientSocket) {
        ...
        String assignedIP = dhcpLeases.get(clientMAC);
        ...
        if (assignedIP != null) {  // Если у клиента уже есть аренда
            ...
            String firstIP = availableIPs.get(0);  // Берем первый доступный IP

            // Выводим информацию о предложении нового IP-адреса
