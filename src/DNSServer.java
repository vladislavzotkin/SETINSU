...
public class DNSServer {
    ...
    public static void main(String[] args) {
        ...
        if (!portInput.isEmpty()) {
            try {
                ROUTER_PORT = Integer.parseInt(portInput);
    ...
    public void start(Scanner scanner) {
        try {
            ...
            closeConnection(); // Закрываем соединение перед выходом
        }
    }
     ...
     *
     * @param requestType Код типа запроса
